...
if DevAli:get(ReLaX.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(ReLaX.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(ReLaX.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ReLaXName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ReLaXName then 
ReLaXNames = DevAli:smembers(ReLaX.."Ali:Mute:Names"..msg.chat_id_) or ""
...
DevAli:set(ReLaX.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(ReLaX.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
